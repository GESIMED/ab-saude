                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'HOME_PAGE_contentView_1_ON_TAP');
                                logFirebaseEvent('contentView_1_navigate_to');

                                context.pushNamed('CadClientes');
                              },
                              child: AnimatedContainer(
                                duration: Duration(milliseconds: 200),
                                curve: Curves.easeInOut,
                              ...
                              children: [
                                Expanded(
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOME_PAGE_Container_j7upw5hi_ON_TAP');
                                      logFirebaseEvent(
                                ...
                                Expanded(
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOME_PAGE_Container_2tvm8ecs_ON_TAP');
                                      logFirebaseEvent(
                                          'Container_set_dark_mode_settings');
                                      setDarkModeSetting(
                      ...
                      child: Row(
                        ...
                        children: [
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'HOME_PAGE_Icon_nmjcjb0u_ON_TAP');
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HOME_PAGE_Icon_n8859p5j_ON_TAP');
