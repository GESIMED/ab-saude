...
class PushNotificationsWidget extends StatefulWidget {
  const PushNotificationsWidget({Key? key}) : super(key: key);

  @override
  _PushNotificationsWidgetState createState() =>
...
class _PushNotificationsWidgetState extends State<PushNotificationsWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PushNotifications'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('PUSH_NOTIFICATIONS_arrow_back_rounded_IC');
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Preencha o formulário abaixo para enviar uma notificação.',
